...
integer, parameter :: Z = 100 !速度空間grid数
real*8, parameter :: pi = 4.d0*atan(1.d0) !円周率
character(len=80) :: dummy !使用しない列用
integer :: MV = 28 !極小値(not parameter)
integer :: HATL = 61 !下段(not parameter)
integer :: LATL = 75 !上段(not parameter)、HATL <= LATL
...
62 format(1PE25.15E3, 2(',', 1PE25.15E3)) !3固定
