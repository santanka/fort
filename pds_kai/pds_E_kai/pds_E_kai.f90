...
character(len=128) :: fileBC = 'pds_BC_E_kai_5.csv'
...
character(len=128) :: fileIC = 'pds_IC_E_kai_5.csv'
...
character(len=128) :: fileresult = 'pds_E_kai_5_result.csv'
72 format(1PE25.15E3, 18(',', 1PE25.15E3)) !kind+7
character(len=128) :: filepote = 'pds_E_kai_5_potential.csv'
82 format(1PE25.15E3, 15(',', 1PE25.15E3)) !kind+4
character(len=128) :: filemin = 'pds_E_kai_5_min.csv'
92 format(1PE25.15E3) !1
character(len=128) :: filecheck = 'pds_E_kai_5_check.csv'
...
subroutine NewtonPhi(N, MV, CP, Phih, cvg, nPhi)
 ...
 search = 1
 if(MV < N .and. MV >= 1 .and. (i /= CP .and. i+1 /= CP)) then
   do while(search == 1)
    search = 0
    do k = 1, 5
     do i = MV, N-1
