...
character(len=128) :: fileBC = 'pds_BC_E_kai_L=15_2.csv'
...
character(len=128) :: fileIC = 'pds_IC_E_kai_L=15_2.csv'
...
character(len=128) :: fileresult = 'pds_E_kai_L=15_2_result.csv'
72 format(1PE25.15E3, 18(',', 1PE25.15E3)) !kind+7
character(len=128) :: filepote = 'pds_E_kai_L=15_2_potential.csv'
