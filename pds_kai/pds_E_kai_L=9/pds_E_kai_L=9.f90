...
character(len=128) :: fileBC = 'pds_BC_E_kai_L=9_5.csv'
...
character(len=128) :: fileIC = 'pds_IC_E_kai_L=9_5.csv'
...
character(len=128) :: fileresult = 'pds_E_kai_L=9_5_result.csv'
72 format(1PE25.15E3, 18(',', 1PE25.15E3)) !kind+7
character(len=128) :: filepote = 'pds_E_kai_L=9_5_potential.csv'
82 format(1PE25.15E3, 15(',', 1PE25.15E3)) !kind+4
character(len=128) :: filemin = 'pds_E_kai_L=9_5_min.csv'
92 format(1PE25.15E3) !1
character(len=128) :: filecheck = 'pds_E_kai_L=9_5_check.csv'
