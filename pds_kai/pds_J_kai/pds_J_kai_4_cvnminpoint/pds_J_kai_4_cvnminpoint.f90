...
integer, parameter :: MV_itn = 78 !極大値
...
character(len=128) :: fileBC = 'pds_BC_J_kai_4_cvnminpoint.csv'
...
character(len=128) :: fileIC = 'pds_IC_J_kai_4_cvnminpoint.csv'
...
!保存ファイル名
character(len=128) :: filetop = 'pds_J_kai_4_cvnminpoint'
