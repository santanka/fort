...
character(len=128) :: fileBC = 'pds_BC_J_kai_5.csv'
...
character(len=128) :: fileIC = 'pds_IC_J_kai_5.csv'
...
!保存ファイル名
character(len=128) :: filetop = 'pds_J_kai_5_'
...
character(len=128) :: file_cvn = 'pds_J_kai_5_cvn.csv'
