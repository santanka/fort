...
character(len=128) :: filemin = 'pds_J_kai_5_cvnminpoint_min.csv'
...
!保存ファイル
character(len=128) :: fileall = 'pds_J_kai_5_cvnminpoint_all.csv'
...
character(len=128) :: fileoption = 'pds_E_kai_5_cvnminpoint_disfun_'
