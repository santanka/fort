...
integer, parameter :: MV_fix = 117 !極値となる座標
integer, parameter :: MV_itn = 74 !極小値
...
character(len=128) :: fileBC = 'pds_BC_J_kai_6_cvnminpoint.csv'
...
character(len=128) :: fileIC = 'pds_IC_J_kai_6_cvnminpoint.csv'
...
!保存ファイル名
character(len=128) :: filetop = 'pds_J_kai_6_cvnminpoint'
