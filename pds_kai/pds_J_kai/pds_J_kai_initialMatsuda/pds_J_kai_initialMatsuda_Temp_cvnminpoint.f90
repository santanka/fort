...
character(len=128) :: filemin = 'pds_J_kai_initialMatsuda_cvnminpoint_65-2_min.csv'
...
!保存ファイル
character(len=128) :: fileall = 'pds_J_kai_initialMatsuda_cvnminpoint_65-2_all.csv'
...
character(len=128) :: fileoption = 'pds_J_kai_initialMatsuda_cvnminpoint_65-2_disfun_'
